...
public:
    ...
    // Expose internal buffer as numpy array
    py::array_t<double> array() {
        // Create a numpy array that shares memory with m_data
        // Shape is (nrow, ncol), with C-style (row-major) layout
        return py::array_t<double>(
            {m_nrow, m_ncol},           // shape
            {m_ncol * sizeof(double), sizeof(double)}, // strides (row-major)
            m_data.data(),              // data pointer
