...
PYBIND11_MODULE(_matrix, m) {
    ...
    m.def("bytes",       [](){ return (long long)myAllocator<double>::counter.bytes(); });
    m.def("allocated",   [](){ return (long long)myAllocator<double>::counter.allocated(); });
    m.def("deallocated", [](){ return (long long)myAllocator<double>::counter.deallocated(); });
}